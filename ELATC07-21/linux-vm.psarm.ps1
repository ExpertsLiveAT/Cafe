...
param(
  ...
  [Parameter()]
  [string]
  $virtualNetworkName = 'ElatvNet',

  [Parameter()]
  [string]
  $subnetName = 'ElatSubnet',

  [Parameter()]
  [string]
  $networkSecurityGroupName = 'ElatSecGroupNet',

  [Parameter()]
  [ValidateSet('12.04.5-LTS', '14.04.5-LTS', '16.04.0-LTS', '18.04-LTS', '20.04-LTS')]
  [string]
  $ubuntuOSVersion = '18.04-LTS',

  [Parameter()]
  [ValidateSet('germanywestcentral', 'westeurope')]
  $location
)
